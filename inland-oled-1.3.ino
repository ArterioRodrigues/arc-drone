...
// devices with all constructor

calls is here:http://code.google.com/p/u8glib/
...
//U8GLIB_SSD1351_128X128_HICOLORu8g(8, 9, 7); // Arduino, HW SPI Com: SCK = 76, MOSI = 75, CS = 8, A0 = 9, RESET = 7 (http://electronics.ilsoft.co.uk/ArduinoShield.aspx)
