...
//
// Yaw follows prop rotation: m1/m4 spin one way, m2/m3 the other. A prop's
// reaction torque on the frame is opposite to its own rotation, so speeding up
// the CW pair (m1/m4) yaws the frame CCW. Yaw is therefore ADDED to m1/m4 and
